ZIP_NAME ?= "customDataTypeGeonames.zip"
...
build: clean buildinfojson ## clean, compile, copy files to build folder
				...
				cat src/tmp/CustomDataTypeGeonamesFacet.js >> build/$(PLUGIN_NAME)/webfrontend/customDataTypeGeonames.js
				cat src/tmp/geonamesUtil.js >> build/$(PLUGIN_NAME)/webfrontend/customDataTypeGeonames.js

				cp src/updater/geonamesUpdater.js build/$(PLUGIN_NAME)/updater/geonamesUpdater.js # build updater
				cat src/tmp/geonamesUtil.js >> build/$(PLUGIN_NAME)/updater/geonamesUpdater.js
